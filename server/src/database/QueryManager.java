...
public class QueryManager {
    ...
    public static final String CLEAR_OBJECTS = "delete from routes where (id = ?) returning id;";

    public static final String DELETE_OBJECT = "delete from routes where (id = ?) returning id;";
